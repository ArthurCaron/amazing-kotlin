...
class AmazingOriginal(randomSeed: Long? = null) {
    ...
    fun doit(horizontal: Int, vertical: Int): String {
        ...
        val wArray = Array(h + 1) { IntArray(v + 1) }
        for (i in 0..h) {
            wArray[i] = IntArray(v + 1)
        }
        val vArray = Array(h + 1) { IntArray(v + 1) }
        for (i in 0..h) {
            vArray[i] = IntArray(v + 1)
        }
        var q = 0
        var z = 0
        var x = rnd(h)
        ...
        while (target != -1) {
            when (target) {
                210 -> if (r != h) GOTO(250) else GOTO(220)
                220 -> if (s != v) GOTO(240) else GOTO(230)
                230 -> {
                    r = 1
                    s = 1
                    GOTO(260)
                ...
                310 -> if (r == h) GOTO(350) else GOTO(320)
                ...
                350 -> if (s != v) GOTO(380) else GOTO(360)
                ...
                430 -> if (r == h) GOTO(530) else GOTO(440)
                440 -> if (wArray[r + 1][s] != 0) GOTO(530) else GOTO(450)
                450 -> if (s != v) GOTO(480) else GOTO(460)
                ...
                530 -> if (s != v) GOTO(560) else GOTO(540)
                ...
                620 -> if (r == h) GOTO(720) else GOTO(630)
                630 -> if (wArray[r + 1][s] != 0) GOTO(720) else GOTO(640)
                640 -> if (s != v) GOTO(670) else GOTO(650)
                ...
                720 -> if (s != v) GOTO(750) else GOTO(730)
                ...
                780 -> GOTO(980)
                790 -> if (r == h) GOTO(880) else GOTO(800)
                800 -> if (wArray[r + 1][s] != 0) GOTO(880) else GOTO(810)
                810 -> if (s != v) GOTO(840) else GOTO(820)
                ...
                870 -> GOTO(1020)
                880 -> if (s != v) GOTO(910) else GOTO(890)
                ...
                960 -> if (c == h * v + 1) GOTO(1200) else GOTO(970)
                970 -> {
                    q = 0
                    GOTO(270)
                }
                ...
                1000 -> {
                    vArray[r][s - 1] = 1
                    s--
                    if (c == h * v + 1) GOTO(1200) else GOTO(1010)
                }
                1010 -> {
                    q = 0
                    GOTO(270)
                ...
                1070 -> if (c == h * v + 1) GOTO(1200) else GOTO(1080)
                1080 -> GOTO(600)
                ...
                1130 -> {
                    s++
                    if (c == v * h + 1) GOTO(1200) else GOTO(1140)
                }
                1140 -> GOTO(270)
